...
> ⚠️ This tool is the result of **reverse engineering** the EpCube mobile app login process.  
> It may stop working if the API or login flow changes.  
> 🗓️ **Created: April 2025**

---

## ✨ Features

- 🔑 Generate a valid **Bearer Token** for the EpCube API
- 🧠 Uses your **existing EpCube login credentials** (email & password)
- 🏠 Designed for use with the [custom Home Assistant integration](#home-assistant-integration)

---

## 🚀 Try it online

👉 **[Launch the app](https://epcube-token.streamlit.app/)**  
...
📦 Coming soon on HACS – or integrate manually from source.
